...
public class Field {
    public static final JavaConsoleFacade JAVA_CONSOLE_FACADE = JavaConsoleFacade.JavaConsole.getInstance();
    private int width;
    private int height;
    ...
    public void print() {
        ...
        JAVA_CONSOLE_FACADE.setBackground(Color.WHITE);
        JAVA_CONSOLE_FACADE.setForeground(Color.black);
        JAVA_CONSOLE_FACADE.clear();
        for (int i = 0; i < height; i++) {
            for (int j = 0; j < width; j++) {
